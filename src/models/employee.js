...
employeeSchema.plugin(versioning, {collection: NAME + "s", mongoose})
let employeeModel = mongoose.model(NAME, employeeSchema)
employeeSchema.statics.ensureIndexes(employeeModel)
